...
Branch-exclusive ratio: 7 of 12 items are exclusive to the `audit` workflow (58%) — above 50% threshold; split placement correct
...
| Major | File type declaration | File type declared before B1 audit begins | One of: Project Instructions / CLAUDE.md / Routing template / System prompt fragment / SKILL.md / unrecognized prepend | Note omission; apply "unrecognized — audited as Project Instructions" path |
