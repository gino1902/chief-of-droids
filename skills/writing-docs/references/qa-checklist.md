<!-- version: 1.3 | author: chief-of-droids workspace | last_updated: 2026-04-29 -->
...
- [ ] If output format is `.docx`: placeholder derivation table displayed to the user AND user confirmed (or corrected) before rendering
